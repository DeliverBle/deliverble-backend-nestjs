...
@Module({
  imports: [
    TypeOrmModule.forFeature([
      NewsRepository, TagRepository, ScriptRepository, SentenceRepository, UserRepository, ScriptDefaultRepository, SentenceDefaultRepository, MemoRepository, ScriptCountRepository, ScriptGuideRepository, SentenceGuideRepository, MemoGuideRepository, RecordingRepository
    ]),
    AuthModule,
  ],
